...
let $offices := (for $x in cts:search(fn:collection('source-trusted')/office,
    ...
    if(fn:exists($x/summary/names/name[type="Office Name"]/value))  then ($x/summary/names/name[type="Office Name"]/value)  else($x/summary/names/name[type='Legal Title']/value)
return $x) [1 to 25]
