...
|Anchor Savings Bank|Name|41031|41031-3|Hewlett, New York, USA|30386260-30364570|
...
Scenario: Verify the legalEntity tab under the data tab should navigate to the legalEntity page(default view).
Given a user is on the search page
When the user clicks on the data tab in the search page
And the user clicks on the legal entity tab in the data area
Then the user should see the message you can search for a legal entity at any time using the header search
