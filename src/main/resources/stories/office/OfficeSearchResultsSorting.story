...
Then the office search results should sort by type with sorted ascending order by office type with fid 1568 from the database
...
Then the office search results should sort by type with sorted descending order by office type with fid 1568 from the database
