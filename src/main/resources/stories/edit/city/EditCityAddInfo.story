Meta:@EditCityAddInfo @Edit @City
...
Then the user should be able to enter values in the add info field 

Scenario: To update the City's 'Basic Info' by entering a value for 'Add Info' that is different from the current value and is within 500 unicode characters
Given a user is on the search page
When the user clicks on the data tab in the search page
And the user clicks on the city tab in the data area
When the user clicks on the choose a country option
...
And the user clicks on the city basic info link in the navigation bar
And the user clicks on the update link
And the user should be able to enter values which is within 500 unicode characters in the add info field 
...
When the user clicks on the save button
And the user clicks on the confirm button
And the user should see the successful update message at top of the page
