...
And the user should not see the deleted entity type value Bank in the zeus document for fid <fid>
...
And the user clicks on the office update link
When the user gets the document with get id for offices with the <officeFid> from the database
Then the user should see the first_row_existing_officetype_delete_button in disabled state in entity types section
...
Then the user should still see the office second_existing_entitytype_dropdown with value xyz in office type in office page

When the user clicks on the second_row_existing_officetype_delete_button in office types section
When the user clicks on the yes button in the delete row confirmation modal in the office page

Then the user should not see the second_row_existing_officetype_dropdown with value xyz in office type in office page

When the user clicks on the save button
Then the user should see the save confirmation modal
When the user clicks on the confirm button
Then the user should not see the deleted office type value Commercial Bank in the zeus document for fid <officeFid>
And the user reverts the changes to the document
...
Examples:
|entity|searchBy|fid|officeFid|entityTypeValue
|1010|FID|1010|1010-44||
