...
and
JIRA ID - ZEUS-1299 _ User can edit Office's Locations(Addresses)
...
|1010|FID|1010|1010-45|mailing|123 Marie Ln|345 Palmer Dr|456 Franklin Ln|789 Apple Valley|
...
And the user enters office telecoms value office_telecoms_first_row_new_value1 value as <Value1>
And the user enters office telecoms value office_telecoms_first_row_new_value2 value as <Value2>
And the user enters office telecoms value office_telecoms_first_row_new_value3 value as <Value3>
...
Examples:
|entity|searchBy|fid|officeFid|Type|Rank|TextBefore|Value1|Value2|Value3|RangeLimit|Ext|TextAfter|AnswerBack|
...
Scenario: a)Verify that the error message "required" is displayed when Country is  selected and when the Address Type is not null
          b)Verify that the error message "required" is not displayed when Country is not selected and when the Address Type is null
