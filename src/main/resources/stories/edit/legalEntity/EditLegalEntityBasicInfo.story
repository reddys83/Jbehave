...
Then the user should see the identifier values for first_row_existing_identifier_type_drodpdown from lookup THIRD_PARTY_IDENTIFIER_LEGAL_ENTITY except the values that are selected already
