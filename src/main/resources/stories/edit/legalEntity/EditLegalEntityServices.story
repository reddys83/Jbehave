...
And the user should see the financial details dropdown i.e legalEntity_first_row_existing_financial_details_dropdown values from lookup FINANCIAL_SERVICE
...
And the user selects financial category i.e legalEntity_first_row_new_financial_category_dropdown value as <financialCategory>
...
And the user should see the financial details dropdown i.e legalEntity_first_row_new_financial_details_dropdown values from lookup FINANCIAL_SERVICE
