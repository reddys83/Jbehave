...
Scenario: Verify whether User saves 'Registrar Fee SFDC Subscription Numbe' & 'Routing Code Comment' are saved successfully in routing code page
...
Scenario: Verify whether User can update (no different to current value) 'Registrar Fee SFDC Subscription Numbe' & 'Routing Code Comment' successfully in routing code page
...
Examples:
|entity|searchBy|routingCode|codeType|registarFeeSFDCSubscription|routingCodeComment|
|083905216|Routing Code|083905216|ABA|408125|existing text for Routing Code Comment|

Scenario: Verify whether User can update blank values for  'Registrar Fee SFDC Subscription Numbe' & 'Routing Code Comment' and successfully in routing code page
