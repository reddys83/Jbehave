    ...
    public void verifySearchResultsNavigation() {
        if (Integer.parseInt(getOfficeSearchResultsLastNavigationPage()) > 7) {
            if (Integer.parseInt(getOfficeSearchResultsCurrentPage()) <= 4) {
                assertEquals(getDriver().findElement(office_search_results_navigation_xpath).getText().toString().replace("â€¦","").replace("…",""), "Previous 1 2 3 4 5  " + getOfficeSearchResultsLastNavigationPage() + " Next");
                ...
                assertEquals(getDriver().findElement(office_search_results_navigation_xpath).getText().toString().replace("â€¦","").replace("…",""), "Previous 1  " +
                ...
                assertEquals(getDriver().findElement(office_search_results_navigation_xpath).getText().toString().replace("â€¦","").replace("…",""), "Previous 1  " +
                        ...
                        getOfficeSearchResultsLastNavigationPage() + " Next".replace("…",""));
            }
        } else {
