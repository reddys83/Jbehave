...
public class AreaIdentifiers {
	...
	public static void setIdentifiers() {
		...
		hmap.put("area_intrest_rate_xpath_after_save",By.xpath("//*[@id='areaBasicInfo']//tr[th='Interest Rate Limit']/td"));
		hmap.put("area_intrest_rate_text_xpath",By.xpath("//*[@id='areaBasicInfo']//tr[th='Interest Rate Limit']/td/input"));
	}
