...
public class CityIdentifiers {
	...
	public static void setIdentifiers() {
		...
		hmap.put("city_add_info_text_entered_xpath",
				By.xpath(("//*[@id='cityBasicInfo']/ul/li[2]/table/tbody/tr[10]/td")));
		hmap.put("city_save_confirmation_message_id", By.xpath(("//*[@id='saveSuccess']")));
		hmap.put("city_addInfo_error_message_edit_xpath",
				By.xpath("//*[@id='cityBasicInfo']/ul/li[2]/table/tbody/tr[10]/td/p"));
	}
