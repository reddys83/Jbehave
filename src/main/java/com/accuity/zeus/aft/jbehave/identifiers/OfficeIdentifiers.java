...
public class OfficeIdentifiers {
    ...
    public static void setIdentifiers() {
        ...
        hmap.put("office_country_dropdown_list", By.xpath(".//*[@id='addrcountry-0']//*[@class='chosen-single']"));
        hmap.put("office_area_dropdown_list_view", By.xpath(".//*[@id='addrarea-0']//*[@class='chosen-single']"));
        hmap.put("office_address_country_type_ahead", By.xpath(".//*[@id='addrcountry-0']/td/div/div/div/input"));
        hmap.put("office_address_city_type_ahead", By.xpath(".//*[@id='addrcity-0']/td/div/div/div/input"));
        hmap.put("office_area_dropdown_list", By.xpath(".//*[@id='addrarea-0']//ul/li"));
        hmap.put("office_area_dropdown", By.xpath(".//*[@id='addrarea-0']/td/div/a/div/b"));
        hmap.put("office_area_dropdown_type_ahead", By.xpath(".//*[@id='addrarea-0']/td/div/div/div/input"));
        hmap.put("office_subarea_dropdown_list", By.xpath(".//*[@id='addrsubarea-0']/td/div/a"));
        hmap.put("office_subarea_dropdown", By.xpath(".//*[@id='addrsubarea-0']/td/div/a/div/b"));
        hmap.put("office_subarea_dropdown_typeAhead", By.xpath(".//*[@id='addrsubarea-0']/td/div/div/div/input"));
        hmap.put("office_city_dropdown_xpath", By.xpath(".//*[@id='addrcity-0']/td/div/a"));
        hmap.put("office_city_dropdown_list", By.xpath(".//*[@id='addrcity-0']//ul/li"));
