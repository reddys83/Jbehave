...
public class OfficeIdentifiers {
    ...
    public static void setIdentifiers() {
        ...
        hmap.put("office_business_hours_text_edit_mode_xpath",By.xpath("//*[@id='officeBasicInfo']//input[@name='businessHours']"));
        hmap.put("office_business_hours_text_view_mode_xpath", By.xpath("//*[@id='officeBasicInfo']//tr[th='Business Hours']/td"));
    }
