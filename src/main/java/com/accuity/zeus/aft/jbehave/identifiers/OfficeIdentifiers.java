...
public class OfficeIdentifiers {
    ...
    public static void setIdentifiers() {
       ...
       // hmap.put("office_subarea_dropdown_list_xpath", By.xpath(".//*[@id='addrsubarea-0']//*[@class='chosen-single']"));
        ...
        hmap.put("office_telecoms_first_row_new_value1", By.xpath(".//*[@id='additionalLocationTelecomms-0']//tr[1]//input[@name='telecommValueCountry']"));
        hmap.put("office_telecoms_first_row_new_value2", By.xpath(".//*[@id='additionalLocationTelecomms-0']//tr[1]//input[@name='telecommValueArea']"));
        hmap.put("office_telecoms_first_row_new_value3", By.xpath(".//*[@id='additionalLocationTelecomms-0']//tr[1]//input[@name='telecommValueNumber']"));
        ...
        hmap.put("office_address_country_error_msg_xpath", By.xpath(".//*[@id='officeLocations']//li[@class='address new']//select[@data-error_id='addrcountryError'] "));
