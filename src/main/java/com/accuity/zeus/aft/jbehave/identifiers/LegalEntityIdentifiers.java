...
public class LegalEntityIdentifiers {
    ...
    public static void setIdentifiers(){
        ...
        hmap.put("legalEntity_new_row_identifier_type_dropdown",By.xpath("//*[@id='additionalIdentifiers']//tr[@class='new'][1]//select[@data-internal_id='identifierType']"));
        hmap.put("legalEntity_new_row_identifier_status_dropdown",By.xpath("//*[@id='additionalIdentifiers']//tr[@class='new'][1]//select[@data-internal_id='identifierStatus']"));
        ...
        hmap.put("legalEntity_new_identifier_type_error_msg_xpath",By.xpath("//tbody[@id='additionalIdentifiers']/tr[@class='new']/td[1]"));
        hmap.put("legalEntity_new_identifier_value_error_msg_xpath",By.xpath("//tbody[@id='additionalIdentifiers']/tr[@class='new']/td[2]"));
        hmap.put("legalEntity_new_identifier_status_error_msg_xpath",By.xpath("//tbody[@id='additionalIdentifiers']/tr[@class='new']/td[3]"));
        hmap.put("legalEntity_first_row_new_delete_identifiers_button", By.xpath("//*[@id='additionalIdentifiers']/tr[@class='new']/td[@class='delete-row']/button"));
